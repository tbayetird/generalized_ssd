...
def train_VOC(data_config,model_config,base_model_config):
    '''
    ...
    ##################################
    datadir=data_config.DATA_DIR
    src_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    local_dir=src_dir
    img_shape=model_config.IMG_SHAPE
    classes = model_config.CLASSES
    checkpoint_output=os.path.join(local_dir,'models',data_config.CHECKPOINT_NAME)
    model_output=os.path.join(local_dir,'models',data_config.MODEL_NAME)
    ...
    batch_size = data_config.BATCH_SIZE # Change the batch size if you like, or if you run into GPU memory issues.
    ...
    weights_path = base_model_config.PATH
